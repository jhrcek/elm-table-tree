...
{
	if (region.S.F === region._.F)
	{
		return 'on line ' + region.S.F;
	}
	return 'on lines ' + region.S.F + ' through ' + region._.F;
}
...
var $author$project$Main$blobToRecords = function (str) {
...
var $author$project$Main$recordsToCells = function (records) {
	var maximumLength = A2(
		$elm$core$Maybe$withDefault,
		0,
		$elm$core$List$maximum(
			A2($elm$core$List$map, $elm$core$List$length, records)));
	var paddedRecords = A2(
		$elm$core$List$map,
		function (xs) {
			return _Utils_ap(
				xs,
				A2(
					...
					maximumLength - $elm$core$List$length(xs),
					''));
		},
		records);
	return $elm$core$Dict$fromList(
		$elm$core$List$concat(
			A2(
				...
				F2(
					function (rowIdx, record) {
						return A2(
							$elm$core$List$indexedMap,
							F2(
								function (colIdx, cellValue) {
									return _Utils_Tuple2(
										_Utils_Tuple2(rowIdx, colIdx),
										cellValue);
								}),
							record);
					}),
...
var $author$project$Main$blobToCells = A2($elm$core$Basics$composeR, $author$project$Main$blobToRecords, $author$project$Main$recordsToCells);
var $author$project$Main$initialBlob = 'Jan,33,Tester,male\nJane,40,Shop assistant,female\nDan,60,Professor,male\nLydia,40,Clerk,female';
var $elm$core$Platform$Cmd$batch = _Platform_batch;
var $elm$core$Platform$Cmd$none = $elm$core$Platform$Cmd$batch(_List_Nil);
var $author$project$Main$init = function (_v0) {
	return _Utils_Tuple2(
		{
			m: $author$project$Main$blobToCells($author$project$Main$initialBlob),
			j: 4,
...
var $author$project$Main$swapColumns = F3(
	function (from, to, cells) {
		var swapColIndex = function (_v0) {
			var _v1 = _v0.a;
			var a = _v1.a;
			var b = _v1.b;
			var val = _v0.b;
			return _Utils_Tuple2(
				_Utils_Tuple2(
					a,
					_Utils_eq(b, from) ? to : (_Utils_eq(b, to) ? from : b)),
				val);
		};
		return $elm$core$Dict$fromList(
			A2(
...
var $author$project$Main$toCellId = F2(
	function (row, col) {
		return $elm$core$String$fromInt(row) + (':' + $elm$core$String$fromInt(col));
	});
			...
			case 3:
				...
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							m: $author$project$Main$blobToCells(blob)
						}),
					$elm$core$Platform$Cmd$none);
			case 1:
				var row = msg.a;
				...
				return _Utils_Tuple2(
					...
					A2(
						...
						$elm$browser$Browser$Dom$focus(
							A2($author$project$Main$toCellId, row, col))));
			case 2:
				return _Utils_Tuple2(
					_Utils_update(
						model,
			...
			case 6:
				...
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							m: A3($author$project$Main$swapColumns, col1, col2, model.m)
						}),
					$elm$core$Platform$Cmd$none);
			default:
...
var $author$project$Main$BlobPasted = function (a) {
	return {$: 3, a: a};
};
...
var $author$project$Main$CellLostFocus = {$: 2};
var $author$project$Main$CellTyped = F3(
	function (a, b, c) {
		return {$: 0, a: a, b: b, c: c};
	});
var $author$project$Main$SwapColumns = F2(
	function (a, b) {
		return {$: 6, a: a, b: b};
	});
...
var $author$project$TreeBuilder$groupByHead = function () {
	var f = F2(
		function (xs, acc) {
			if (!acc.b) {
				return _List_fromArray(
				...
				return _Utils_eq(
					...
					A2(
						...
						$elm$core$List$head,
						$elm$core$List$head(ys))) ? A2(
					$elm$core$List$cons,
					A2($elm$core$List$cons, xs, ys),
					yss) : A2(
					$elm$core$List$cons,
					_List_fromArray(
						[xs]),
					A2($elm$core$List$cons, ys, yss));
			}
		});
...
var $author$project$TreeBuilder$buildForest = function (xss) {
	var xsss = $author$project$TreeBuilder$groupByHead(
		$author$project$TreeBuilder$sortByHead(xss));
	return A2(
		$elm$core$List$filterMap,
		function (group) {
			var tailsToBeGrouped = A2($elm$core$List$filterMap, $elm$core$List$tail, group);
			return A2(
				$elm$core$Maybe$map,
				function (label) {
					return A2($author$project$TreeBuilder$buildTree, label, tailsToBeGrouped);
				},
				A2(
					$elm$core$Maybe$andThen,
					$elm$core$List$head,
					$elm$core$List$head(group)));
		},
		xsss);
};
...
var $author$project$Main$cellsToRecords = F3(
	function (rowCount, columnCount, cells) {
		return A2(
			$elm$core$List$map,
			function (row) {
				return A2(
...
var $alex_tan$elm_tree_diagram$TreeDiagram$TopToBottom = 2;
var $alex_tan$elm_tree_diagram$TreeDiagram$defaultTreeLayout = {K: 100, aL: 2, N: 40, R: 50, U: 80};
		...
		var visited = A3(
			...
			F2(
				function (prelimPos, subtree) {
					return A4($alex_tan$elm_tree_diagram$TreeDiagram$final, level + 1, levelHeight, lOffset + prelimPos.u, subtree);
				}),
...
var $alex_tan$elm_tree_diagram$TreeDiagram$rootOffset = F2(
	function (lPrelimPosition, rPrelimPosition) {
		return ((((lPrelimPosition.u + rPrelimPosition.u) + lPrelimPosition.s) + rPrelimPosition.s) / 2) | 0;
	});
	...
	function (siblingDistance, subtreeDistance, _v0) {
		...
		if (!_v2.$) {
			...
			var treeContour = A2(
				$elm$core$List$cons,
				rootContour,
				A3($alex_tan$elm_tree_diagram$TreeDiagram$buildContour, lSubtreeContour, rSubtreeContour, rPrelimPos.u));
			return _Utils_Tuple2(
				A2(
					$alex_tan$elm_tree_diagram$TreeDiagram$Node,
...
var $alex_tan$elm_tree_diagram$TreeDiagram$draw_ = F5(
	function (drawer, layout, drawNode, drawLine, tree) {
		var positionedTree = A5($alex_tan$elm_tree_diagram$TreeDiagram$position, layout.R, layout.U, layout.K, layout.aL, tree);
		return A5($alex_tan$elm_tree_diagram$TreeDiagram$drawPositioned, drawer, layout.N, drawNode, drawLine, positionedTree);
	});
var $alex_tan$elm_tree_diagram$TreeDiagram$Drawable = F3(
	function (position, compose, transform) {
		return {Y: compose, O: position, V: transform};
	});
...
var $author$project$TreeBuilder$drawLine = function (_v0) {
	var targetX = _v0.a;
	var targetY = _v0.b;
	return A2(
		$elm$svg$Svg$line,
...
var $author$project$TreeBuilder$drawNode = function (label) {
	return A2(
		$elm$svg$Svg$g,
		_List_Nil,
		_List_fromArray(
...
var $author$project$Main$recordsToBlob = function (records) {
	return A2(
		$elm$core$String$join,
		'\n',
		A2(
...
var $author$project$Main$ChangeColumnCount = function (a) {
	return {$: 5, a: a};
};
var $author$project$Main$ChangeRowCount = function (a) {
	return {$: 4, a: a};
};
var $elm$html$Html$button = _VirtualDom_node('button');
var $elm$html$Html$text = $elm$virtual_dom$VirtualDom$text;
var $author$project$Main$tableControls = F2(
	function (rowCount, colCount) {
		var createButtonIf = F2(
			function (cond, btn) {
				return cond ? _List_fromArray(
					[btn]) : _List_Nil;
			});
		var but = F2(
			function (msg, txt) {
		...
		var removeColumn = A2(
			...
			A2(
				but,
				$author$project$Main$ChangeColumnCount(-1),
				'Remove column'));
		var removeRow = A2(
			createButtonIf,
			rowCount > 0,
			A2(
				but,
				$author$project$Main$ChangeRowCount(-1),
				'Remove row'));
		var addRow = A2(
			createButtonIf,
			rowCount < 11,
...
var $author$project$Main$view = function (model) {
	var renderValue = F2(
		function (row, col) {
			var valString = A3($author$project$Main$getValueAt, row, col, model.m);
			return _Utils_eq(
				model.E,
				$elm$core$Maybe$Just(
					_Utils_Tuple2(row, col))) ? A2(
				$elm$html$Html$input,
				_List_fromArray(
					[
						$elm$html$Html$Events$onInput(
						A2($author$project$Main$CellTyped, row, col)),
						$elm$html$Html$Events$onBlur($author$project$Main$CellLostFocus),
						$elm$html$Html$Attributes$id(
						A2($author$project$Main$toCellId, row, col)),
						$elm$html$Html$Attributes$value(valString),
						A2($elm$html$Html$Attributes$style, 'display', 'table-cell'),
						A2($elm$html$Html$Attributes$style, 'width', '99%')
					]),
				_List_Nil) : $elm$html$Html$text(valString);
		});
	var renderHeaderCell = function (col) {
		return A2(
			...
			_Utils_ap(
					...
					[
						...
						_List_fromArray(
							[
								...
								A2($author$project$Main$SwapColumns, col, col - 1))
							]),
						_List_fromArray(
							[
								$elm$html$Html$text('◀ ')
				...
				(_Utils_cmp(col, model.j - 1) < 0) ? _List_fromArray(
					[
						A2(
						$elm$html$Html$span,
						_List_fromArray(
	...
	var renderHeader = A2(
		...
		A2(
			$elm$core$List$map,
			renderHeaderCell,
			A2($elm$core$List$range, 0, model.j - 1)));
	var renderCell = F2(
		function (row, col) {
			return A2(
				$elm$html$Html$td,
				_List_fromArray(
					[
						$elm$html$Html$Events$onClick(
						A2($author$project$Main$CellClicked, row, col)),
						A2(
						$elm$html$Html$Attributes$style,
						'width',
						$elm$core$String$fromInt((100 / model.j) | 0) + '%')
					]),
				_List_fromArray(
					[
						A2(renderValue, row, col)
					]));
		});
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$elm$html$Html$text('CSV Data')
					])),
				A2(
				$elm$html$Html$textarea,
				_List_fromArray(
					[
						$elm$html$Html$Events$onInput($author$project$Main$BlobPasted),
						$elm$html$Html$Attributes$rows(model.t),
						$elm$html$Html$Attributes$cols(40),
						$elm$html$Html$Attributes$value(
						$author$project$Main$recordsToBlob(records)),
						$elm$html$Html$Attributes$placeholder('Paste CSV data here ...')
					]),
				_List_Nil),
				A2(
				$elm$html$Html$h2,
				...
				_List_fromArray(
					[
						$elm$html$Html$text('Parsed Data')
					])),
				A2($author$project$Main$tableControls, model.t, model.j),
				renderTable,
				A2(
				$elm$html$Html$h2,
				_List_Nil,
